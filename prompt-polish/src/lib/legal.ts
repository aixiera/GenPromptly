export const legalCompanyName =
  process.env.NEXT_PUBLIC_LEGAL_COMPANY_NAME?.trim() || "Kairui Bi";

export const legalContactEmail =
  process.env.NEXT_PUBLIC_LEGAL_CONTACT_EMAIL?.trim() || "bia446635@gmail.com";

export const legalContactHref = `mailto:${legalContactEmail}`;

export const privacyEffectiveDate = "Effective Date: March 9, 2026";
export const privacyLastUpdated = "Last Updated: March 9, 2026";

export const termsContactEmail =
  process.env.NEXT_PUBLIC_TERMS_CONTACT_EMAIL?.trim() || legalContactEmail;

export const termsEffectiveDate = "Effective Date: March 9, 2026";
export const termsLastUpdated = "Last Updated: March 9, 2026";
